...
@foreach ($posts as $post)
  @if(!$post->photo == null)
    <div class="row" style="width:60%;margin-left:20%;border-top-right-radius:5px;border-top-left-radius:5px;border:1px solid #595959">
      ...
      <div class="col-md-9 border " style="background:white;border-bottom-right-radius:5px;border:1px solid #595959;height:220px">
          <h6>{{$post->body}}</h6>
                <a href="{{ route('admin.posts.show', $post->id) }}" class="btn btn-dark" style="margin-left:25%;border-radius:20px;margin-top:140px">
                    <h6>
